...
`u2-mark-transparent-master.png` is the production transparent mark derived
from that exact design, and `u2-app-icon-master.png` is its high-resolution
...
| `u2-mark-transparent-master.png`       | 1254×1254  | Transparent      | High-resolution production mark for derived assets.                                          |
| `u2-app-icon-master.png`               | 1254×1254  | Opaque navy      | High-resolution white-hat app icon master.                                                    |
