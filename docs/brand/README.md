...
`u2-approved-reference.png` is the authoritative approved identity sheet.
...
| `u2-approved-reference.png`            | 1536×1024  | Opaque light     | Authoritative approved U2 identity sheet.                                                     |
