...
visual source for platform exports. `mark-transparent-master.png` mirrors that
same artwork for consumers that require the legacy transparent-mark filename.
...
| `mark-transparent-master.png`          | 1254×1254  | Opaque navy      | Legacy-named mirror of the exact approved playful master.                                     |
