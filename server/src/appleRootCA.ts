import { decodeBase64 } from "./appleJws";

// Apple Root CA - G3, the root of the chain Apple signs StoreKit transactions
// and App Store Server Notifications with.
//
// Published at https://www.apple.com/certificateauthority/AppleRootCA-G3.cer
// Downloaded and pinned 2026-08-19. SHA-256 fingerprint:
//   63:34:3A:BF:B8:9A:6A:03:EB:B5:7E:9B:3F:5F:A7:BE:7C:4F:5C:75:6F:30:17:B3:A8:C4:88:C3:65:3E:91:79
// Subject and issuer: CN=Apple Root CA - G3, OU=Apple Certification Authority,
// O=Apple Inc., C=US. Valid 2014-04-30 to 2039-04-30.
//
// A root certificate is public material — pinning it here is the point, and
// there is nothing secret to leak. Verify the fingerprint above against Apple's
// published value before ever replacing these bytes: everything this server
// believes about who has paid rests on them.
...
/// Decoded once at module load rather than per request: it never changes, and
/// this runs on the verification path of every notification Apple sends.
export const APPLE_ROOT_CA_G3_DER: Uint8Array = decodeBase64(APPLE_ROOT_CA_G3_BASE64);
